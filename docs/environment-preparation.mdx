...
1. Open `Android Studio`
    - If it is not the first time running `Android Studio`, the welcome screen appears, in that case, select `New Project` from the top and the new  project template is shown:
    <br/>
    <img src="images/24-image.png" width="70%"  alt="Welcome"/>
    <br/>

    - If it is the first time running, the new project template is shown by default.
    <br/>
