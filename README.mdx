...
Go to the download link at <a src="https://developer.android.com/studio" target="_blank">Android Studio</a> and follow the instructions to download and install `Android Studio` on your computer.
